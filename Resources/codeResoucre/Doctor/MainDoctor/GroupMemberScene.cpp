...
//获取队长名字
    ...
    for (int i=0; i<index; i++) {
        ...
        if ( strcmp(object["isRecieve"].GetString(), "1")==0) {
            leaderName=object["name"].GetString(); break;
        }
    }
    auto userLB = Label::createWithSystemFont(leaderName,"Arial",38,Size(300,60),TextHAlignment::LEFT,TextVAlignment::CENTER);
